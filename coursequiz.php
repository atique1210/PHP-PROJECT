  ...
  <html>
    ...
    <body>
      ...
      <?php
        ...
        //           $sql=mysqli_query($con,"CREATE OR REPLACE TRIGGER `course_gate` AFTER DELETE ON `courses` BEGIN UPDATE `users` SET `courses_sub`= $cr+1 WHERE `firstname`=$name;");
