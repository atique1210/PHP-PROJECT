    ...
    <body>
      ...
      <div class="row amber darken-4" style="font-family: 'Russo One', sans-serif;" id="aboutus">
        <div class="col s8 offset-s2">
          ...
          <p class="dark"><br><br><br><br>Three college students<i> - Hemant Upadhyay, Atique Siddiqui, and Shubham Phansekar</i><br> saw firsthand how education technology fell short of its promise to improve the learning experience for students and instructors.</h5><br><br><br>They decided to change that by building an LMS aligned with the needs and learning style of education in the real world.</p><br><br><br>
        </div>
      </div>
      <div class="row" style="background-image: url('schoology-careers-desktop_0.jpg');height: 50em;"><br><br><br>
